...
class User(models.Model,ModelMixin):
    ...
    phonenum=models.CharField(max_length=50,verbose_name='手机号',unique=True)
    nickname=models.CharField(max_length=64,verbose_name='昵称',unique=True)
    gender=models.CharField(max_length=8,verbose_name='性别',choices=SEX)
    birthday=models.DateTimeField(verbose_name='出生日',default='2020-1-1')
...
class Profile(models.Model,ModelMixin):
    # dating_location=models.CharField(verbose_name='目标城市')
